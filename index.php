...
<head>
    ...
    <title>Glorious - Buy & Sell Products</title>
    ...
    <style>
        ...
        .-container * {
            font-family: Poppins, "Century Gothic", "Didact Gothic", Montserrat;
            color: black;
        }
        ...
        .-category_items>.-category_item>.-img {
            ...
            height: 73px;
            margin: 0px auto;
            background-image: radial-gradient(circle at center top, rgb(14, 95, 213) 20%, rgb(10, 67, 150) 100%);
            padding: 15px;
            border-radius: 50%;
        ...
        .-category_items>.-category_item.-flash_sales>.-img {
            background-image: radial-gradient(circle at center top, red 20%, rgb(188, 0, 1) 100%);
        }
        ...
        .-category_items>.-category_item.-live_giveaways>.-img {
            background-image: radial-gradient(circle at center top, rgb(138, 186, 255) 20%, rgb(10, 67, 150) 100%);
        }
...
<body>
  <!-- <button onclick="topFunction()" id="myBtn" title="Go to top">Top</button></a> -->
   
    <div class="loader"></div>
    <div class="app-container" style="height:auto;">

        <div class="app-content">
            <div id="app"  style="position: sticky;top:0;z-index: 1 ;display: flex;align-items: center;justify-content: space-between;background-color: #0f2a689d;padding-left: 16px;height:55px">
            ...
            <div class="app-content-actions">
                <input class="search-bar" id="myInput" placeholder="Search..." type="text">
                <div class="app-content-actions-wrapper">
                    <div class="filter-button-wrapper">
                        ...
                        <div class="filter-menu">
                            ...
                            <select class="category-select" style="cursor: pointer;color:white;background-color: black;">
                                <option style="cursor: pointer;" value="">All Categories</option>
                                <option style="cursor: pointer;" value="Furniture">Furniture</option>
                                <option style="cursor: pointer;" value="Arts & Craft">Arts & Craft</option>
                                <option style="cursor: pointer;" value="Automotive">Automotive</option>
                                <option style="cursor: pointer;" value="Beauty and Personal Care">Beauty and Personal Care</option>
                                <option style="cursor: pointer;" value="Books">Books</option>
                                <option style="cursor: pointer;" value="Fashion">Fashion</option>
                                <option style="cursor: pointer;" value="Computers">Computers</option>
                                <option style="cursor: pointer;" value="Health & Household">Health & Household</option>
                                <option style="cursor: pointer;" value="Industrial and Scientific">Industrial and Scientific</option>
                                <option style="cursor: pointer;" value="Movies & TV">Movies & TV</option>
                                <option style="cursor: pointer;" value="Decoration">Decoration</option>
                                <option style="cursor: pointer;" value="Kitchen">Kitchen</option>
                                <option style="cursor: pointer;" value="Electronic">Electronic</option>
                                <option style="cursor: pointer;" value="Other">Other</option>
                            </select>
                            <label>Status</label>
                            <select class="status-select" style="cursor: pointer;color:white;background-color: black;">
                                <option value="">All Status</option>
                                <option value="Active">Active</option>
                                <option value="Disabled">Disabled</option>
                            </select>
                            <div class="filter-menu-buttons">
                                <button class="filter-button reset" style="opacity: 0;">
                                    Reset
                                </button>
                                <button class="filter-button apply" style="float: right ;">
                                    Apply
                                </button>
                            </div>
                        </div>
            ...
            <div class="-container -cbs hide-load">
                <div class="row">
                    <div class="-category_items">
                        <a href="" class="-category_item -flash_sales">
                            <div class="-img -deals">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/flash-sales-white.png" alt="Flash Sales">
                            </div>
                            <div class="-txt">
                                <span>flash</span>
                                <span>sales</span>
                            </div>
                        </a><a href="" class="-category_item -live_giveaways">
                            <div class="-img -deals">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/live-giveaways.png" alt="Live Giveaways">
                            </div>
                            <div class="-txt">
                                <span>live</span>
                                <span>giveaways</span>
                            </div>
                        </a><a href="" class="-category_item">
                            <div class="-img -deals">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/women-bags-white.png" alt="Women's Bags">
                            </div>
                            <div class="-txt">
                                <span>women's</span>
                                <span>bags</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/mobile-cases-white.png" alt="mobile cases">
                            </div>
                            <div class="-txt">
                                <span>mobile</span>
                                <span>cases</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/mens-sneakers-white.png" alt="men's sneakers">
                            </div>
                            <div class="-txt">
                                <span>men's</span>
                                <span>sneakers</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/women-rings-white.png" alt="women rings">
                            </div>
                            <div class="-txt">
                                <span>women</span>
                                <span>rings</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/car-care-white.png" alt="car care">
                            </div>
                            <div class="-txt">
                                <span>car</span>
                                <span>care</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/memory-cards-white.png" alt="memory cards">
                            </div>
                            <div class="-txt">
                                <span>memory</span>
                                <span>cards</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/babys-fashion-white.png" alt="baby's fashion">
                            </div>
                            <div class="-txt">
                                <span>baby's</span>
                                <span>fashion</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/lighting-white.png" alt="lighting">
                            </div>
                            <div class="-txt">
                                <span>lighting</span>
                            </div>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/mens-tshirt-white.png" alt="men's t-shirt">
                            </div>
                            <div class="-txt">
                                <span>men's</span>
                                <span>t-shirt</span>
                            ...
                            <div class="-img">
                                <img src="https://ng.jumia.is/cms/8-18/jumia-global-universe/makeup-brushes-white.png" alt="makeup brushes">
                            </div>
                            <div class="-txt">
                                <span>makeup</span>
                                <span>brushes</span>
            ...
            <div style="padding: 30px;" class=" hide-load">
                <h1 style="color: white;">Top Selling Categories</h1>
                <div style="display: flex;align-items: center;justify-content: center;gap:20px;margin-top: 30px;margin-bottom: 40px;">
                    <a href="#" style="text-decoration: none;">
                        <div style="text-align: center;">
                            <img style="width: 180px;height:180px;border-radius: 50%;" src="./src/mobile.jpg" alt="">
                            <p style="color: white;">Mobile Phones</p>
                        </div>
                    </a>
                    <a href="#" style="text-decoration: none;">
                        <div style="text-align: center;">
                            <img style="width: 180px;height:180px;border-radius: 50%;" src="./src/electro.jpg">
                            <p style="color: white;">Electronics</p>
                        </div>
                    </a>
                    <a href="#" style="text-decoration: none;">
                        <div style="text-align: center;">
                            <img style="width: 180px;height:180px;border-radius: 50%;" src="./src/computer.jpg" alt="">
                            <p style="color: white;">Computers</p>

                        </div>
                    </a>
                    <a href="#" style="text-decoration: none;">
                        <div style="text-align: center;">
                            <img style="width: 180px;height:180px;border-radius: 50%;" src="./src/kitchen.jpg" alt="">
                            <p style="color: white;">Kitchen</p>
                        </div>
                    </a>
                    <a href="#" style="text-decoration: none;">
                        <div style="text-align: center;">
                            <img style="width: 180px;height:180px;border-radius: 50%;" src="./src/fur.jpg">
                            <p style="color: white;">Furniture</p>
                        </div>
                    </a>
                    <a href="#" style="text-decoration: none;">
                        <div style="text-align: center;">
                            <img style="width: 180px;height:180px;border-radius: 50%;" src="./src/download.jpg">
            ...
            <div style="text-align: center;" class=" hide-load">
                <h1 style="color:white">Daily Discover</h1>
            </div>
            ...
            <div class="products-area-wrapper gridView">
                <div class="products-header">
                    ...
                    <div class="product-cell sales">Sold<button class="sort-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
                            </svg>
                        </button></div>
                ...
                <?php $product_info = $mysqli->query("SELECT * FROM profile_information INNER JOIN product_details ON product_details.user_id = profile_information.id WHERE profile_information.id != '$id'");
                foreach ($product_info as $info) {

                ?>
                    <form class="products-row" action="add-process.php" enctype="multipart/form-data" method="post" style="padding:20px">
                        <input type="text" name="user_id" style="display: none;" value="<?= $id ?>">
                        <input type="text" name="product_id" style="display: none;" value="<?= $info['id'] ?>">
                        <input type="text" name="quantity" style="display: none;" value="1">
                        <input type="text" name="subtotal" style="display: none;" value="<?= $info['price'] ?>">
                        ...
                        <div class="product-cell image">
                            <img src="test/uploads/<?= $info['product_image'] ?>" alt="product">
                            <span class="product_name"><?= $info['product_name'] ?></span>
                            <br>
                            <small style="color: #2869ff;">- <?= $info['product_info'] ?>.</small>
                            <br>
                            <small>| Owner: <?= $info['name'] ?></small>
                        </div>
                        <div class="product-cell category"><span class="cell-label">Category: </span><span class="category"><?= $info['category'] ?></span></div>
                        <input type="text" class="status_span" value="<?= $info['status'] ?>" style="display: none;" />
                        <div class="product-cell status-cell">
                            <span class="cell-label">Status:</span>
                            <span class="status active "><b><?= $info['status'] ?></b></span>

                        </div>
                        <div class="product-cell sales"><span class="cell-label">Sold:</span>0 sold</div>
                        <div class="product-cell stock"><span class="cell-label">Stock:</span><?= $info['stock'] ?> pc/s</div>
                        <div class="product-cell price"><span class="cell-label">Price:</span>Php. <?= $info['price'] ?></div>

                        <?php if ($info['status'] == "Active") { ?>
                            <button class="app-content-headerButton" name="addcart">Add to Cart</button>
                        <?php } else { ?>
                            <input class="app-content-headerButton" style="background-color: #bb2124;" type="submit" value="Disabled" disabled>
                        <?php } ?>
                    </form>
    ...
    <script>
        ...
        document.querySelector('#myInput').addEventListener('keyup', function(event) {
            if (event.key === "Enter") {
                ...
                const myTimeout = setTimeout(function() {
                    ...
                    document.querySelectorAll('.hide-load').forEach((item) => {
        ...
        document.querySelector('.apply').addEventListener('click', function(event) {
            ...
            var c_select = document.querySelector('.category-select').value.toUpperCase();
            var status_select = document.querySelector('.status-select').value.toUpperCase();
            // alert(c_select);
            // alert(status_select);
            document.querySelector('.loader').style.display = "block";
            const myTimeout = setTimeout(function() {
            ...
            // alert(status_.value);
            for (i = 0; i < products_row.length; i++) {
                var category = products_row[i].getElementsByClassName("category")[0];
                var status_span = products_row[i].getElementsByClassName("status_span")[0];

                var txtValue = category.textContent || category.innerText;
                var txtValue2 = status_span.value || status_span.textContent;

                // alert(txtValue.toUpperCase());

                if ((txtValue.toUpperCase().indexOf(c_select) > -1) && (txtValue2.toUpperCase().indexOf(status_select) > -1)) {
                    products_row[i].style.display = "";
                } else {
                    products_row[i].style.display = "none";
                }
