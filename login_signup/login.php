...
if (isset($_POST["submit"])) {
  ...
  $result = mysqli_query($conn, "SELECT * FROM profile_information WHERE email = '$email'");
      ...
      <div id="signin">
        ...
        <form class="" action="" method="post" autocomplete="off">
          ...
          <div class="field-wrap">
            ...
            ?>" style="background:#FFFFFF;font-weight:bold" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="input" name="email" id="email" type="email" required autocomplete="off" />
          </div>
          ...
          <div class="field-wrap">
            ...
            <input style="background:#FFFFFF" minlength="8" name="password" id="password" class="input" type="password" value="" required autocomplete="off" />
            <?php
            if (isset($error)) {
              foreach ($error as $error) {
                echo '<span style ="color: red; margin-left: 15px">' . $error . '</span>';
              };
            };
            ?>
          </div>
          ...
          <div class="field-wrap" style="text-align: center;">
            <input type="submit" name="submit" value="Sign In" class="button button-block">
            <a style="color:#2869ff;font-size: 13px;" href="register.php">Don't have an account? Sign up</a>
          </div>
